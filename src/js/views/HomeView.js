          ...
          <div class="features">
            <div class="features__item">
              <div class="features__icon">
                <img
                  class="features__img"
                  src="${getImage("icon-whole-food-recipes.svg")}"
            ...
            <div class="features__item">
              <div class="features__icon">
                <img
                  class="features__img"
                  src="${getImage("icon-minimum-fuss.svg")}"
                  alt="Minimum fuss"
                />
              </div>
              <div class="features__description">
            ...
            <div class="features__item">
              <div class="features__icon">
                <img
                  class="features__img"
                  src="${getImage("icon-search-in-seconds.svg")}"
          ...
          <div class="section__image skeleton">
            <picture class="lazy-load">
              <source media="(min-width: 701px)" data-srcset="${getImage(
                "image-home-real-life-large.webp"
              )}">
              <source media="(max-width: 700px)" data-srcset="${getImage(
                "image-home-real-life-small.webp"
              )}">

              <img
                src="${getImage("placeholder-image-rectangle.webp")}"
                alt="Hero image"
                data-src="${getImage("image-home-real-life-small.webp")}"
