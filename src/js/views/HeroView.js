            ...
            <div class="hero__image skeleton">
              <picture class="lazy-load">
                <source media="(min-width: 701px)" data-srcset="${getImage(
                  "image-home-hero-large.webp"
                )}">
                <source media="(max-width: 700px)" data-srcset="${getImage(
                  "image-home-hero-small.webp"
                )}">

                <img
                  src="${getImage("placeholder-image-rectangle.webp")}"
                  alt="Hero image"
                  data-src="${getImage("image-home-hero-small.webp")}"
        ...
        <div class="container">
          <div class="hero__content">
            ...
            <div class="hero__image skeleton">
              <picture class="lazy-load">
                <source media="(min-width: 701px)" data-srcset="${getImage(
                  "image-about-our-mission-large.webp"
                )}">
                <source media="(max-width: 700px)" data-srcset="${getImage(
                  "image-about-our-mission-small.webp"
                )}">

                <img
                  src="${getImage("placeholder-image-rectangle.webp")}"
                  alt="Hero image"
                  data-src="${getImage("image-about-our-mission-small.webp")}"
                  class="u-responsive-img"
                />
              </picture>
            </div>
